...
namespace WebTty.Transport
{
    public class WebSocketsTransport : ITransport
    {
        ...
        public WebSocketsTransport(IConnection connection)
        {
        ...
        public async Task ProcessAsync(HttpContext context)
        {
            using (var socket = await context.WebSockets.AcceptWebSocketAsync())
            {
                try
                {
                    await ProcessSocketAsync(socket, _connection.Application);
                }
                finally
                {
        ...
        private async Task ProcessSocketAsync(WebSocket socket, IDuplexPipe application)
        {
            var receiving = StartReceiving(socket, application);
        ...
        private async Task StartReceiving(WebSocket socket, IDuplexPipe application)
        {
